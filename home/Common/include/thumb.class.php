...
class ThumbHandler
{
    ...
    function _createMaskWord($src)
    {
        ...
        else
        {
            imagettftext($src,
                        $this->font_size, 0,
                        $this->mask_pos_x, $this->mask_pos_y+14,
                        $color,
                        $this->font,
                        $this->mask_word);
            if(isset($this->mask_word2))
            {
            	if(isset($this->mask_txt_pct2)) 
            	{
            		$color = imagecolorallocatealpha($src, $c[0], $c[1], $c[2], $this->mask_txt_pct2);
            	}
            	
	            imagettftext($src,
	                        $this->font_size+7, 0,
	                        $this->mask_pos_x+140, $this->mask_pos_y-$this->font_size,
	                        $color,
	                        $this->font,
	                        $this->mask_word2);
            }
